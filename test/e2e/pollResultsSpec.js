var PollResults = function () {
  ...
  this.ballotViewTitle = element(by.id("ballotTitle"));
  this.ballotViewOriginator = element(by.id("ballotOriginator"));
  this.ballotViewDate = element(by.id("date-box"));
  this.ballotViewDescription = element(by.id("ballotDescription"));
